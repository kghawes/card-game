...
class Quest:
    def __init__(self, quest_id, description, encounters, enemy_cache, card_cache, status_registry):
        self.description = description
        self.encounters = []
        for encounter in encounters:
            self.encounters.append(Encounter(enemy_cache.create_enemy(encounter, card_cache, status_registry)))
...
class QuestRegistry:
    def __init__(self, quests_path, enemy_cache, card_cache, status_registry):
        ...
        for quest_id, quest_details in quest_data.items():
            ...
            self.quests.append(Quest(quest_id, description, encounters, enemy_cache, card_cache, status_registry))