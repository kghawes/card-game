...
class ModifierManager:
    ...
    def clear_effect_modifiers(self, status):
    ...
    def recalculate_all_effects(self, status_registry):
    ...
    def modify_card_effect(card, effect, modifier):
    ...
    def reset_card_effect(card, effect):
        for effect_id, effect_level in card.effects.items():
            if effect in effect_id:
