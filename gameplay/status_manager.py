...
class StatusManager:
    ...
    def change_status(
        ...
        if status_id not in self.statuses:
            subject.modifier_manager.clear_effect_modifiers(status, subject.card_manager)
        subject.modifier_manager.recalculate_all_effects(status_registry, subject.card_manager)
